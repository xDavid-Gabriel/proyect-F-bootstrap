...
export default function Pagina5Cards({producto}) {
    ...
    const {nombre, precio, descripcion, area, imagen, implementar, direccion } = producto
        ...
        <>
            ...
            <div className="card1 card mb-3 shadow ">
                <div className="card-body">
                    ...
                    <p className="card-text"><small className="text-muted">Listed in {direccion}</small></p>
